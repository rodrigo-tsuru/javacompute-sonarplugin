...
public class ClearMbMessageTest {
...
//	    }
  ...
  public void detected() {
    ...
    ClearMbMessageCheck check = new ClearMbMessageCheck();

    SourceFile file = JavaAstScanner
      .scanSingleFile(new File("src/test/files/ClearMbMessage.java"), new VisitorsBridge(check,CLASSPATH_JAR));
    	

    System.out.println(file.getCheckMessages().size());
