...
public class Teste_JavaCompute extends MbJavaComputeNode {
	...
	public void evaluate(MbMessageAssembly inAssembly) throws MbException {
		...
		try {
			...
			// ----------------------------------------------------------
			outMessage.getRootElement().createElementAsLastChild(MbMRM.ROOT_ELEMENT_NAME);
			outMessage.getRootElement().createElementAsFirstChild(MbXMLNS.ROOT_ELEMENT_NAME);
